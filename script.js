...
function showModal(card, rarity) {
  ...
  div.innerHTML = `
    <style>
      ...
      .gc-img { background: #1a1a2e; padding: 16px; text-align: center; position: relative; }
      ...
      .gc-placeholder-dots {
        font-size: 18px; color: ${rarity.color}66;
      ...
      .gc-img img.loaded { opacity: 1; }
      .gc-img img.loaded + .gc-placeholder { display: none; }
      .gc-img img:hover { opacity: .85 !important; }
      ...
      <div class="gc-img">
        <div class="gc-img-wrap">
          <img
            src="${card.imgUrl}"
            alt="${card.title}"
            onerror="this.src='${card.imgFallback}';this.onerror=null;this.classList.add('loaded');"
            onload="this.classList.add('loaded');"
            onclick="window.open('${card.itemUrl}','_blank')"
            title="Voir sur Gallica">
          <div class="gc-placeholder">
            <div class="gc-placeholder-icon">📜</div>
            <div class="gc-placeholder-text">Consultation des archives</div>
            <div class="gc-placeholder-dots">· · ·</div>
          </div>
        </div>
...
function showModal(card, rarity) {
  ...
  div.innerHTML = `
    <style>
      ...
      .gc-placeholder-icon { font-size: 36px; opacity: .3; }
      .gc-placeholder-text {
    ...
    <div class="gc">
      ...
      <div class="gc-img">
        <div class="gc-img-wrap">
          <div class="gc-placeholder">
            <div class="gc-placeholder-icon">📜</div>
            <div class="gc-placeholder-text">CHARGEMENT EN COURS</div>
          </div>
          <img
            src="${card.imgUrl}"
            alt="${card.title}"
